        ...
        <div className="flex flex-grow w-full h-full">
            ...
            <div className="flex flex-col w-8/12 p-8">
                <div className="flex justify-between">
                    ...
                    <a href={project.github} target="_blank" className="bg-gray-900 p-1.5 rounded-lg flex justify-between hover:shadow-xl">
                ...
                <div className="mt-auto flex">
                    {
                        project.technologies.map(technology => <div className="mr-5 font-medium text-gray-500" key={technology}>{technology}</div>)
                    }
                </div>
            </div>
        </div>
